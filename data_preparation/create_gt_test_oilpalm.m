...
path = ['../data-oilpalm/oilpalm-test/IMG_Palm/'];
gt_path = ['../data-oilpalm/oilpalm-test/ground_truth/'];
gt_path_csv = ['../data-oilpalm/oilpalm-test/ground_truth_csv/'];
test_txt = ['../data-oilpalm/oilpalm-test/test.txt'];
